...
fun main() {
    ...
    var datat2 = TrianguloDataClass(15f, 15f, 15f)
    ...
    //Posso simplesmente não passar valor nenhum que ele copia de forma identica ou informar apenas os valores que quero mudar
    datat2 = datat1.copy(a = 14f)
    println(datat2.toString())
}
